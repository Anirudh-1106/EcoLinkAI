            ...
            with open(req_file, mode="r", encoding="utf-8") as f:
                ...
                for row in rows:
                    ...
                    ex_req = ExchangeRequest(
                        ...
                        material_compatibility=Decimal("100.00"),
                        quantity_compatibility=Decimal(str(round(quantity_compat, 2))),
                        quality_compatibility=Decimal(str(round(quality_compat, 2))),
